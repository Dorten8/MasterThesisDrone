...
The 1600KV motor on 6S should hover in the \textbf{45--50\% throttle range} based on the estimated drone weight and motor thrust.\cite{bershadsky2016propulsion} This operating point---hovering near the motor efficiency peak---means extractable maximum flight time from the battery while maintaining responsive control authority (50\% throttle reserves 50\% available thrust for maneuvers and environmental disturbances).
...
\hline
Hover throttle & \textasciitilde45--50\% & Operates at motor efficiency peak; reserves 50\% available thrust\cite{bershadsky2016propulsion} \\
\hline
