...
The \textbf{Pixhawk 6C} runs PX4 Autopilot firmware (\texttt{v1.16.1rc}) and is responsible for low-level attitude control, motor mixing, and sensor fusion.\footnote{Confirmed via the experimental session logs; the \texttt{v1.16.1rc} tag is the release-candidate version that shipped with the Pixhawk 6C and remained unchanged throughout all experimental flights.}
