...
Coordinate frame conventions differ between MoCap and PX4, and this is their first explicit treatment in this thesis. The OptiTrack system reports poses in the standard \textbf{ENU (East-North-Up)} frame: $X$ points East, $Y$ points North, $Z$ points Up. PX4's internal state estimator operates in the \textbf{NED (North-East-Down)} frame: $X$ points North, $Y$ points East, $Z$ points Down. The vehicle's body frame follows the \textbf{FRD (Forward-Right-Down)} convention: $X$ points forward (nose direction), $Y$ points right, $Z$ points down.\cite{PX4Docs}
...
\todo{[USER ACTION - PX4 Frame Image: Insert the official explanatory diagram of the ENU/NED/FRD coordinate frames from the PX4 documentation here.]}
