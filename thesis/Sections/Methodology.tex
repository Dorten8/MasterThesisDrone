...
\end{figure}
\subsubsection{Predecessor Constraints and Design Objectives}
...
\textbf{Lower bound: payload minimum.} The Raspberry~Pi~5 companion computer ($\sim$60\,g plus peripherals) and the PETG protective cage (35.8\,cm diameter, bearing assembly) together require a minimum thrust budget that class-3-inch and below platforms cannot provide. A typical 3-inch build lacks both the stator diameter and the propeller disc area to lift these components while maintaining a safe TWR margin.
...
\textbf{The 4-inch sweet spot.} At this scale, 2004-stator motors paired with 4-inch GF4023 propellers on a 6S battery produce sufficient lift for the companion computer and cage while hovering at 45--50\% throttle---near the efficiency peak. The Pixhawk~6C form factor (84.8\,$\times$\,44\,$\times$\,12.4\,mm) fits within the 4-inch frame envelope, making the platform fully self-contained.\cite{TechnicalSpecificationHolybro2025} The resulting TWR of $\sim$3.8:1 places the drone in the responsive research-autonomy band, with enough thrust to arrest post-collision drift and recover to the commanded setpoint.
...
\subsubsection{Source Submodules}
...
\subsubsection{The Flight Director}
...
\subsection{Frame and Cage Design}
