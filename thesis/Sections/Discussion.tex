...
The IMU vibration data reveals qualitatively distinct post-impact mechanical behaviors between the two designs. The fixed cage drags against the column surface, producing sustained high-frequency pitch and roll oscillations consistent with stick-slip resonance \cite{bowden2001friction}.% TODO [USER]: Insert citation for Bowden \& Tabor (2001) regarding stick-slip friction here.
