...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "from experiments_analysis.exa_kinematics import compute_velocity, find_waypoint_events, build_events_log\n",
            "from experiments_analysis.exa_plot_kinematics import plot_velocity_profile, plot_imu_dynamics, plot_imu_xyz_components\n",
            "\n",
